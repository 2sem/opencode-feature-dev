...
function buildWorkflowPrompt(argumentsText) {
...
function extractSlashArguments(raw) {
...
export const FeatureDevPlugin = async () => {
    return {
        ...
        "chat.message": async (_input, output) => {
            const index = findFeatureDevPartIndex(output.parts);
            if (index < 0) {
                return;
            }
            ...
            injectPrompt(output.parts, buildWorkflowPrompt(extractSlashArguments(part.text)));
        },
